...
?>
         <div class="col-md-2 col-md-offset-1 panel panel-primary">
            <br>
            <a href="viewDisplayItems.php?category=<?php echo $value['id']; ?>"><img src="data:image;base64,<?php echo $value['categoryImg'];?>" class="center-block" style="width:60px;height:60px;"></a>
